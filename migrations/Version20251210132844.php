 ...
 */
final class Version20251210132844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE asset (id INT AUTO_INCREMENT NOT NULL, workspace_id INT NOT NULL, contact_id INT DEFAULT NULL, company_id INT DEFAULT NULL, deal_id INT DEFAULT NULL, src VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_2AF5A5CE7A1254A (contact_id), INDEX IDX_2AF5A5C979B1AD6 (company_id), INDEX IDX_2AF5A5CF60E2305 (deal_id), INDEX idx_asset_workspace (workspace_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
